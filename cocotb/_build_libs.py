...
class build_ext(_build_ext):
    ...
    def get_ext_filename(self, ext_name):
        ...
        # icarus requires vpl extension, gpivpi is default in Makfiles
...
# Allow to load dependencies from direcotry where vpi/vhpi/fli library is located on osx
...
def _get_common_lib_ext(include_dir, share_lib_dir, sim_define):
    ...
    libgpilog = Extension(
        ...
        include_dirs=[include_dir],
        libraries=[_get_python_lib_link(), "pthread", "m", "cocotbutils"],
